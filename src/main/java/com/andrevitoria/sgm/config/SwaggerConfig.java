package com.andrevitoria.sgm.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.andrevitoria.sgm.resources"))
				.paths(PathSelectors.any())
				.build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API SGM", "Esta API é utilizada para gestão de documentos", "Versão 1.0",
				"https://www.udemy.com/", new Contact("André", "udemy.com/user/andrevitoria", "andrevitoria@gmail.com"),
				"Download Permitido", "https://www.udemy.com/terms", Collections.emptyList() // Vendor
																								// Extensions
		);
	}
